...
?>
    ...
    <form id="reg_form">
        <p>
            ...
            <input name="login" id="login" type="text" size="24" minlength="6" maxlength="24" required="required">
        </p>
        <p>
        ...
        <p>
            ...
            <input name="confirm" id="confirm" type="password" size="24" maxlength="24" required="required">
        </p>
        <p>
            <label for="email">E-mail:<br></label>
            <input name="email" id="email" type="email" size="24" maxlength="24" required="required">
        </p>
        <p>
            <label for="name">Имя:<br></label>
            <input name="name" id="name" type="text" size="24" minlength="2" maxlength="24" required="required">
        </p>
        <br>
