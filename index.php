...
?>
    ...
    <form id="reg_form">
        <p>
            ...
            <input name="login" id="login" type="text" size="24" minlength="6" maxlength="24">
        </p>
        <p>
        ...
        <p>
            ...
            <input name="confirm" id="confirm" type="password" size="24" maxlength="24">
        </p>
        <p>
        ...
        <p>
            ...
            <input name="name" id="name" type="text" size="24" minlength="2" maxlength="24">
        </p>
        <br>
