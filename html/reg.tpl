...
<form id="reg_form">
    <p>
        ...
        <input name="login" id="login" type="text" size="32" placeholder="Буквы и/или цифры" minlength="6"
               maxlength="32"
...
<p><a href='page_2.php'>Страница 2</a></p>
<p><a href='page_3.php'>Страница 3</a></p>
